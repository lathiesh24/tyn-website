      ...
      <div className="fixed flex flex-row bg-white z-50 h-20 sm:h-16 w-full items-center justify-between">
        ...
        <div className="hidden md:grid text-customBlack grid-flow-col sm:gap-x-6 xl:gap-x-16 sm:mr-4 xl:mr-20 sm:text-xs lg:text-base">
          <div
            ...
            className={`mt-2 cursor-pointer ${activeSection === "about-us"
          ...
          <div
            ...
            className={`mt-2 cursor-pointer ${activeSection === "services"
                ? "underline decoration-customYellow decoration-[3px]"
                : ""
              }`}
          >
          ...
          <div
            ...
            className={`mt-2 cursor-pointer ${activeSection === "our-team"
                ? "underline decoration-customYellow decoration-[3px]"
                : ""
              }`}
          >
