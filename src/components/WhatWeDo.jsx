    ...
    <>
      <div className="bg-bgBlue flex flex-col sm:flex-row  items-center py-4 sm:py-16 sm:gap-10 sm:px-10 sm:justify-around">
        ...
        <div className="2xl:m-0 flex justify-center items-center pt-4 pb-2 sm:pt-0 sm:pb-0">
          <img
            className="rounded-[24px] object-cover cursor-pointer h-[140px] w-[340px] sm:h-auto sm:w-auto"
            src="/image3.png"
            alt="image2"
          />
        </div>
        <div className="flex flex-col sm:gap-8">
          ...
          <div className="flex flex-col py-4 sm:pt-0 gap-6 sm:gap-10 text-base sm:text-xl">
            <div className="bg-white p-3 sm:p-5 rounded-[18px] font-medium sm:text-[18px] sm:w-[450px] 2xl:w-[650px] flex gap-2 sm:gap-4 2xl:gap-4 items-center">
            ...
            <div className="bg-white p-3 sm:p-5 sm:text-[18px] rounded-[18px] font-medium sm:w-[450px] 2xl:w-[650px] flex gap-2 sm:gap-4 2xl:gap-4 items-center">
              <div className="text-customBlue">
                <RiFlowChart size={30} />
              </div>
            ...
            <div className="bg-white p-3 sm:p-5 rounded-[18px] sm:text-[18px]  font-medium sm:w-[450px] 2xl:w-[650px] flex gap-2 sm:gap-4 2xl:gap-4 items-center">
              <div className="text-customBlue">
