                ...
                <div className='flex flex-col justify-center items-center px-4 py-12'>
                    <div className='items-center text-2xl leading-loose tracking-wide font-semibold flex flex-col gap-y-2'>
                        <div className='flex justify-center items-center'>
                            ...
                            <span className='font-light tracking-wider pl-1'> is to deliver </span>
                        </div>
                        <span className='bg-custom-gradient text-transparent bg-clip-text flex justify-center pt-4'>Noiseless Information </span>
                        <span className='text-customBlack flex justify-center'>&</span>
                        <div className='bg-custom-gradient text-transparent bg-clip-text sm:mt-4 xl:mt-2 flex justify-center'>Frictionless Orchestration</div>
                    </div>
